...
const DemoProduct = (props) => {
  useDocTitle("Abtik Services | Demo our products");
            ...
            <div className="w-full bg-white p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl">
              ...
              <div className="flex items-center my-4">
                <input
                  ...
                  type="checkbox"
                  checked={demoProducts.includes("business_management_system")}
              ...
              <div className="flex items-center my-4">
                <input
                  ...
                  aria-describedby="checkbox-1"
                  type="checkbox"
                  checked={demoProducts.includes("school_management_portal")}
                  className="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300 h-4 w-4 rounded"
              ...
              <div className="flex items-center my-4">
                <input
                  ...
                  aria-describedby="checkbox-1"
                  type="checkbox"
                  checked={demoProducts.includes("payroll_management_system")}
                  className="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300 h-4 w-4 rounded"
              ...
              <div className="flex items-center my-4">
                <input
                  ...
                  aria-describedby="checkbox-1"
                  type="checkbox"
                  checked={demoProducts.includes("event_management_system")}
                  className="bg-gray-50 border-gray-300 focus:ring-3 focus:ring-blue-300 h-4 w-4 rounded"
              ...
              <div className="my-2 w-1/2 lg:w-2/4">
                ...
                >
                  {isSubmiting ? "Loading..." : "Send Message"}
                </button>
              </div>
            </div>
          </form>
            ...
            <div className="flex flex-col text-white">
              <div className="flex my-4 w-2/3 lg:w-3/4">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-400">
                    Shilp Corporate Park Block B, 209 - 211, Rajpath Rangoli Rd,
              ...
              <div className="flex my-4 w-2/3 lg:w-1/2">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-400">Tel: 08928138434</p>

                  <div className="mt-5">
                    <h2 className="text-2xl">Send an E-mail</h2>
                    <p className="text-gray-400">info@abtikservices.com</p>
                  </div>
                </div>
              </div>
